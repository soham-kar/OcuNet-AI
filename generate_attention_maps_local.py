# generate_attention_maps_local.py
"""
Local Disease-Specific Attention Map Visualization for GLAAM-4X
================================================================

Runs locally (no Modal) using the venv. Loads the trained A1 model from
cataract-checkpoints_v3 and generates per-disease attention maps.

Usage:
    venv_linux/bin/python generate_attention_maps_local.py
"""
...
OUT_DIR = BASE / "xai_figures" / "attention_maps"
...
def main(n_samples=12):
    ...
    # Select samples (one positive per disease)
    samples = []
